...
const PlayerBar: React.FC<Props> = ({ song, isPlaying, setIsPlaying, currentTime }) => {
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <button 
            ...
            className={`px-4 border border-[#9046FF] font-bold transition-all ${
              isPlaying ? 'bg-[#9046FF] text-black' : 'hover:bg-[#9046FF] hover:text-black'
            }`}
          >
